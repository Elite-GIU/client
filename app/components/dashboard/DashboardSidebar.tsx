...
const DashboardSidebar: React.FC<SidebarProps> = ({ items, isOpen, setIsOpen}) => {
  ...
  return (
    <div className={`${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 fixed h-full w-64 bg-white shadow-lg transition-transform duration-300 ease-in-out`}>
