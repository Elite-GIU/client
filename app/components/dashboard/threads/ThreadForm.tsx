...
export function ThreadForm({ onSubmit }: ThreadFormProps) {
  ...
  return (
    <div className="p-6 rounded-2xl shadow-md bg-white text-black">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 rounded-lg shadow-sm focus:outline-none bg-gray-100 text-black border-gray-300 focus:ring-blue-500"
          />
        </div>
